...
import ExternalRedirect, { AppUrlKeys } from "@/components/customs/alert/ExternalRedirect"; // ถ้ายังต้องใช้ redirect

// ค่าคงที่จากโค้ด Python ที่สำคัญ (อาจจะ hardcode หรือดึงมาจาก config ถ้ามี)
const OBSTACLE_THRESHOLD_CM = 10;
const FORCED_STOP_DURATION_S = 2.0;
const SENSOR_READ_PAUSE_DURATION_S = 3.0;
const PI_INTERPRETATION_LANG_IS_THAI = true; // ตั้งค่าตาม Python ของคุณ
...
const ManualFeature = () => {
  ...
  return (
    <div className='flex flex-col w-full space-y-6 p-4 md:p-8 bg-gray-50'>
      ...
      {/* ปุ่มไปที่หน้าควบคุม (ถ้ายังต้องการ) */}
      <div className="flex flex-col items-center mt-8">
        <Text className="text-xl font-bold text-gray-800 mb-4">พร้อมที่จะควบคุม Diddy แล้วหรือยัง?</Text>
      ...
      <Text className="text-xs text-gray-500 text-center mt-8">Copyright ©2025 Diddy</Text>
    </div>
  );
};

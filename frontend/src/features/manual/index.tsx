  ...
  return (
    <div className='flex flex-col w-full space-y-4'>
      ...
      <div className=" flex-col flex items-center space-y-4 w-full">
        ...
        <Text className="text-gray-700 text-center w-full">พูดผ่านไมค์ที่หน้าควบคุม โดยการกดเปิดให้เป็นสีเขียวและพูดคำสั่งที่ต้องการ จากนั้นรอเวลาประมาลผล เมื่อรถได้ทำตามคำสั่งของคุณแล้วจึงสามารถพูดคำสั่งอื่นได้ <br />เมื่อไม่ต้องการใช้ ให้กดปุ่มปิดไมค์ ถ้าปิดแล้วจะมีสถานะเป็นสีแดง</Text>
        {/* ปุ่มไปที่หน้าควบคุม*/}
